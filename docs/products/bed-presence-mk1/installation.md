...
The [Bed Presence Mk1](https://www.elevatedsensors.com/products/bed-presence-mk1) base kit includes everything needed to
install on beds with standard slats.

- Bed support must be slats or a foundation with slats.
- Slat must be at least 1" wide.
- Space between slats must be at least 2.5".
- The preferred mounting method is a screw into a wooden slat, but mounting tape may be used with metal slats.

If your bed uses a box spring, upholstered base, solid platform, foundation, or doesn't meet the requirements above,
