...
# Bed Presence Mk1 (bpmk1) - Technical Specifications

## Product Overview
- **Product Name**: Bed Presence Mk1 (Bed Presence for ESPHome)
- **Description**: Smart Home Sensor for Detecting Bed Occupancy
- **Manufacturer**: Elevated Sensors, LLC
- **SKU**: bpmk1, bpmk1-single, bpmk1-dual
- **HS Code**: 8543.70
...
- **Operating Current**: 80mA (typical), 500mA (recommended supply)
- **Dimensions** (excludes sensor strips): 2.7" x 1.5" x 0.4" (70mm x 38mm x 10mm)
